...
class OdontologoServiceTest {
    ...
    static void crearTablas(){
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:h2:~/db_odontologos_lasy;INIT=RUNSCRIPT FROM 'create.sql'", "sa", "sa");
        } catch (Exception e) {
            e.printStackTrace();
